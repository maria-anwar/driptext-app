...
const reviews = [
    {
        ...
        review: 'I produced the first content in the shop myself - it worked relatively reliably, but to a certain extent it never "made an impact". Thanks to the content from Driptext, we were able to cover an extremely large number of new topics in a short space of time.',
    },
    {
        name: 'Dario',
        company: 'Natapura',
        review: 'Rising costs in the performance ads area have made us tackle SEO. As a first step, we tried content from DripText - and we are super happy.',
    },
    {
        name: 'Fritz',
        company: 'Servimonda',
        review: 'I came across DripText while looking for a new content creator. The initial conversation was really good and I was really looking forward to it. The offer was detailed and easy to understand. The formalities went smoothly and were child\'s play. The texts are of great quality. Small technical additions were implemented quickly and correctly. The implementation of the texts was flawless, also from an SEO perspective. If you are looking for holistic text creation with a head, DripText is the right place for you. I look forward to continuing to work with them.',
    },
    {
        name: 'Cedric',
        company: 'Changeway',
        review: 'Many thanks to the whole team at DripText. They have been supporting me with various projects for a long time. The collaboration is going very, very well and I am extremely satisfied. Always reliable, very competent and friendly! Here\'s to many more successful years.',
    },
    {
        name: 'Matthias',
        company: 'Nima GmbH',
        review: 'As managing director of Nima GmbH, quality and efficiency are my top priority. I found exactly that at DripText. What particularly impressed me is the reliability of their work. The team behind DripText is characterized by professionalism and delivers results that exceed my expectations. Another strength that I would like to highlight is their uncomplicated communication. They are always approachable, responsive and offer clear solutions. I am extremely satisfied with DripText and look forward to a long-term partnership.',
    },
    {
        name: 'Lars',
        company: 'BIBS pacifier',
        review: 'We have a very limited radius of action with our products. Thanks to the content from DripText, we were able to generate significantly more traffic and sales.',
    },
];
    ...
    return (
        <div className="bg-gradient-to-b from-gray-200 to-sky-200 rounded-2xl xxs:py-8 xxs:px-8 2xl:py-12 2xl:px-12">
            <div className="max-w-6xl mx-auto">
                ...
                <h2 className="text-center text-3xl font-bold mb-6 text-black">I dont want to do without DripTexts texts for my online shop anymore.</h2>
                <p className="text-center mb-12 text-black">What our customers say about us:</p>
                </div>
                ...
                <button className="mt-4 bg-gradient-to-r from-sky-700 to-cyan-500 text-white py-4 px-4 rounded-lg ">
