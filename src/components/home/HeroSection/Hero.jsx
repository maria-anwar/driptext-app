...
// import img from '../../assets/homeimages/img.jpg';
...
const Hero = () => {
  return (
    <div className="relative mt-2">
      ...
      <div className="relative z-10 px-4 py-16 lg:py-20 lg:px-16 flex flex-col items-center">
        <CarousalCards />
        ...
        <div className="mt-5 max-w-4xl">
          ...
          <p className="text-xl text-center mt-4 text-gray-900">
        ...
        <div className="mt-8 flex justify-center">
          <button className="py-4 px-16 bg-yellow-300 text-gray-600 text-xl font-bold rounded-lg hover:bg-yellow-600 transition duration-200">
      ...
      {/* Cards Section */}
      <div className="relative w-full h-64 mb-64"> {/* Adjust negative margin as needed */}
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-40 text-center max-w-7xl mt-16 ml-40">
          <div className="bg-[#101E33] text-white rounded-lg shadow-2xl h-auto md:h-auto flex flex-col justify-between w-96">
            <div>
          ...
          <div className="bg-[#101E33] text-white rounded-lg shadow-2xl h-auto md:h-auto flex flex-col justify-between w-96">            <div>
