...
const CallToActionSection = () => {
  return (
    <section className=" bg-gradient-to-r from-sky-900 to-cyan-500 text-white pt-16 rounded-lg">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center">
        <div className=" mx-10">
          ...
          <button className="bg-white  text-gray-600 font-semibold py-3 px-6 rounded-lg shadow-md hover:bg-gray-100 transition duration-300">
