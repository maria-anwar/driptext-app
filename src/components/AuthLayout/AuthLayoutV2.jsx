...
const AuthLayoutV2 = ({ children }) => {
  ...
  return (
    <div className="grid grid-cols-1 2xl:grid-cols-12 h-screen ">
      {/* Left Column */}
      <div className="col-span-1 2xl:col-span-4 flex flex-col justify-between items-center  py-10 xxs:px-10 2xl:px-10 bg-dark-blue border-r-2 border-gray-200">
      ...
      {/* Right Column */}
      <div className="hidden 2xl:flex 2xl:col-span-8 flex-col h-screen py-6 ">
