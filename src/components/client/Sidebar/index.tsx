            ...
            <div className="mb-6 h-full flex flex-col justify-between">
              <ul className="flex flex-col gap-1.5">
                <li>
                  <NavLink
                    to="/client-dashboard"
                    className={`group relative flex items-center justify-start gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
