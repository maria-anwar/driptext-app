...
const Profile = () => {
  return (
    <>
    <div className="3xl:px-8">

      <Breadcrumb pageName="Profile" />
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="relative z-20 h-35 md:h-65 bg-gray"></div>
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2 h-full">
              <div className="flex items-center h-full justify-center">
                <h2 className="text-title-md2 4xl:text-4xl font-semibold text-black dark:text-white ">
                  TA
                </h2>
              </div>
            </div>
            {/* <div className="hiddden 3xl:absolute 3xl:ml-[29rem] 4xl:ml-[31.52rem] 5xl:ml-[32.5rem] -mt-19 flex justify-end items-start ">
              <Link
                to='settings'
                className="inline-flex items-center justify-end text-center text-lg font-medium text-white bg-black py-3 px-10  hover:bg-opacity-90 lg:px-8 xl:px-10"
              >
                Edit
              </Link>
            </div> */}
          </div>
          {/* <div className="w-full border">derf</div> */}
          ...
          <div className="mt-4">
            ...
            <div className="items- mx-auto mt-4.5 mb-5.5 grid max-w-65 grid-cols-1 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
              <div className="flex flex-col items-center justify-center gap-1 border-stroke px-4 dark:border-strokedark xsm:flex-row">
                <span className="font-semibold xl:text-lg 2xl:text-xl 3xl:text-3xl text-black dark:text-white">
                  20+
                </span>
